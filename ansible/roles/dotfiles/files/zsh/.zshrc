...
#------ more specific keybinding stuff ------
# enable forward-word / backward-word for slash character (why is this not the default behavior?!)
# see https://unix.stackexchange.com/a/48589
export WORDCHARS=${WORDCHARS/\/}

# use Ctrl+Arrowkeys to move between words
bindkey '^[[1;5C' emacs-forward-word
bindkey '^[[1;5D' emacs-backward-word

# use Ctrl+Backspace / Ctrl+Delete to delete words
...
# powerlevel10k: initialization stuff, enable theme and custom prompt
if [[ -r "${XDG_CACHE_HOME:-$HOME/.cache}/p10k-instant-prompt-${(%):-%n}.zsh" ]]; then
  source "${XDG_CACHE_HOME:-$HOME/.cache}/p10k-instant-prompt-${(%):-%n}.zsh"
fi
source "${ZSH_DIR}/powerlevel10k/powerlevel10k.zsh-theme"
[[ ! -f "${ZSH_DIR}/powerlevel10k/p10k_mb.zsh" ]] || source "${ZSH_DIR}/powerlevel10k/p10k_mb.zsh"
...
if [[ -d /usr/share/doc/fzf/examples/ ]] then
	# on Ubuntu: (see 'apt-cache show fzf' which points to /usr/share/doc/fzf/README.Debian)
...
# colors in ls output like bash does
